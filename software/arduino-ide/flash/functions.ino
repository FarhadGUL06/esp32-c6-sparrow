/*
  |~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~|
  | FlashDiagnostic_functions.ino | | SPIMemory library | | v 3.2.0 |
  |~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~|
  |                                                                    Marzogh |
  |                                                                  02.05.2018
  |
  |~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~|
  | | |                                  For a full diagnostics rundown - with
  error codes and details of the errors                                  | |
...
bool getID()
{
	...
	if (!JEDEC) {
		Serial.println("No comms. Check wiring. Is chip supported? If unable "
					   "to fix, raise an issue on Github");
		return false;
	} else {
...
void structTest()
{
	...
	Serial.print("Struct");
	printTab(2);
	if ((_d.s1 == _data.s1) && (_d.s2 == _data.s2) && (_d.s3 == _data.s3) &&
		(_d.s4 == _data.s4) && (_d.s5 == _data.s5) &&
		(_d.structofstruct.b1 == _data.structofstruct.b1) &&
		(_d.structofstruct.b1 == _data.structofstruct.b1)) {
		pass(TRUE);
	} else {
		pass(FALSE);
